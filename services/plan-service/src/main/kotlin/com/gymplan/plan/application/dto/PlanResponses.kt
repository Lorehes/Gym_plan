...
fun WorkoutPlan.toSummaryResponse() = PlanSummaryResponse(
    planId = id!!,
    name = name,
    dayOfWeek = dayOfWeek,
...
fun WorkoutPlan.toDetailResponse() = PlanDetailResponse(
    planId = id!!,
    name = name,
...
fun WorkoutPlan.toTodayPlanResponse() = TodayPlanResponse(
    planId = id!!,
    name = name,
    dayOfWeek = dayOfWeek,
    exercises = exercises.map { it.toResponse() },
...
fun PlanExercise.toResponse() = ExerciseItemResponse(
    id = id!!,
